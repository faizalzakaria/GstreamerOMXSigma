...
{
       0,   576,   576,   583,   587,   588,   590,   591,   594,   597,
     602,   603,   607,   608,   611,   612,   615,   616,   617,   620,
     633,   634,   635,   638,   643,   644,   679,   707,   708,   722,
     742,   762,   765
};
#endif
...
/* Line 1455 of yacc.c  */
#line 590 "./grammar.y"
    { GST_BIN_MAKE ((yyval.c), "bin", (yyvsp[(3) - (4)].c), (yyvsp[(2) - (4)].p)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 591 "./grammar.y"
    { GST_BIN_MAKE ((yyval.c), (yyvsp[(1) - (4)].s), (yyvsp[(3) - (4)].c), (yyvsp[(2) - (4)].p)); 
